...
sleep 1
lncli --rpcserver localhost:${RPCPORT1} openchannel --node_key ${IDENTITYKEY2} --local_amt ${CHANNELSIZE} --push_amt ${PUSHAMOUNT}
sleep 1
...
sleep 1
lncli --rpcserver localhost:${RPCPORT2} openchannel --node_key ${IDENTITYKEY3} --local_amt ${CHANNELSIZE} --push_amt ${PUSHAMOUNT}
sleep 1
start_btcctl generate 10
